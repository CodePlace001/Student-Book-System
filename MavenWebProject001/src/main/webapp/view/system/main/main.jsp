...
<body style="background-color: #f2f9fd;">
	...
	<div class="leftnav">
		...
		<ul style="display: block">
			<li><a href="<%=basePath %>/view/system/main/info.jsp" target="right"><span
		...
		<ul>
			<li><a href="<%=basePath %>/view/system/main/test.jsp" target="right"><span
					class="icon-caret-right"></span>读者管理</a></li>
			<li><a href="<%=basePath %>/view/system/main/xiaomi.jsp" target="right"><span
